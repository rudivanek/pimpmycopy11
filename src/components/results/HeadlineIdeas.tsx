      ...
      <div className="space-y-3">
        {headlines.map((headline, index) => (
          <div key={index} className="flex justify-between items-center bg-gray-100 dark:bg-gray-800 rounded-md p-3 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
            ...
            <button
              className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white transition-colors flex items-center text-sm bg-white dark:bg-gray-900 px-2 py-1 rounded"
